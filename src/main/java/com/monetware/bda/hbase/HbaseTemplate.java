...
public class HbaseTemplate implements HbaseOperations {
    ...
    @Override
    public <T> List<T> find(String tableName, String family , final Filter filter, final RowMapper<T> action) {
        Scan scan = new Scan();
        scan.setCaching(5000);
    ...
    @Override
    public <T> List<T> find(String tableName, String family, String qualifier, final Filter filter, final RowMapper<T> action) {
        Scan scan = new Scan();
        scan.setCaching(5000);
        scan.setFilter(filter);
        scan.addColumn(Bytes.toBytes(family), Bytes.toBytes(qualifier));
    ...
    public <T> List<T> find(String tableName, final Scan scan, final RowMapper<T> action) {
        return this.execute(tableName, (Table table) -> {
